...
app2.post("/api/extract-data", async (req, res) => {
    try {
...
app2.post('/store', uploader.single('file'), async (req, res) => {
    try {
...
app2.get('/fetch/:userAddress/:cid', async (req, res) => {
    try {
...
app2.get('/data/:userAddress', async (req, res) => {
    try {
